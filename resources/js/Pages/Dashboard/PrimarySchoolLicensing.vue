...
<script>
import PrimaryTableLicenced from '../TablePrimaryLicenced/PrimaryTableLicenced';
export default {
components:{
PrimaryTableLicenced,
},
...
this.$store.state.reportTitle='BY OWNERSHIP';
