...
<div class="change_content" v-if="$store.state.reportMenu==='table2'">
...
import PrimaryDistributionByfounderTable from '../TablePrimaryDistribution/PrimaryDistributionByfounderTable';
import PrimaryDistributionByregionTable from '../TablePrimaryDistribution/PrimaryDistributionByregionTable';
export default {
components:{
