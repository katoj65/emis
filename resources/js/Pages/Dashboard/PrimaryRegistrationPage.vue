...
<script>
import PrimaryRegistrationTable from '../TablePrimaryRegistration/PrimaryRegistrationTable';
import PrimaryRegistrationByClass from '../TablePrimaryRegistration/PrimaryRegistrationByClass'
export default {
components:{
PrimaryRegistrationTable,
PrimaryRegistrationByClass
...
this.$store.state.reportTitle='BY REGISTRATION';
