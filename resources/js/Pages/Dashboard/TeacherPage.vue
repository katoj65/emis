...
TEACHERS   <span style="color:#0D47A1;text-transform: uppercase;"> - {{ this.$store.state.reportTitle}}</span> <span style="padding-left:5px;color:#0D47A1;" > {{ this.$store.state.enrolment_year }}</span>
</strong>
...
//import TeachersBySubjectTable from '../TableTeachers/TeachersBySubjectTable';
import TeachersByPayrollTable from '../TableTeachers/TeachersByPayrollTable';

import TeachersByGenderTable from '../TableTeachers/TeachersByGenderTable';

import TeachersByQualificationesTable from '../TableTeachers/TeachersByQualificationesTable';

import TeachersQualificationRegion from '../TableTeachers/TeachersQualificationRegion';
export default {
components:{
//TeachersBySubjectTable,
TeachersByPayrollTable,
TeachersByGenderTable,
TeachersByQualificationesTable,
TeachersQualificationRegion,
