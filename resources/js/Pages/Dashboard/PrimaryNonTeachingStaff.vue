...
<strong style="margin-right:20px;margin-left:35px;text-transform: uppercase;">
PRIMARY SCHOOL None teaching staff
...
<script>
import TableNonTeachingStaff from '../TableNonTeachingStaff/TableNonTeachingStaff'
export default {
components:{
TableNonTeachingStaff,
},
...
//custom data
menu:'table1',
tableTitle:'PRIMARY SCHOOL NONE TEACHING STAFF  ',
...
this.$store.state.reportTitle='BY DISTANCEAND REGION';
