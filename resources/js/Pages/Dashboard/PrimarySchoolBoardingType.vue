...
-
{{ this.$store.state.reportTitle
}}</span> <span style="padding-left:5px;color:#0D47A1;" >
 {{ this.$store.state.enrolment_year }}</span>
</strong>
...
<script>
import PrimarySchoolBoarderStatus from '../TablePrimarySchoolBoarderStatus/PrimarySchoolBoarderStatus';
import PrimarySchoolBoarderByRegion  from '../TablePrimarySchoolBoarderStatus/PrimarySchoolBoarderByRegion';
export default {
components:{
PrimarySchoolBoarderStatus,
PrimarySchoolBoarderByRegion
...
//custom data
menu:'table1',
tableTitle:'Primary  Schools Distribution by ',
...
//load automatically
mounted(){
this.$store.state.reportTitle='BY BOARDER STATUS';
