...
PRIMARY ENROLMENT  <span style="color:#0D47A1;text-transform: uppercase;"> - {{ this.$store.state.reportTitle}}</span> <span style="padding-left:5px;color:#0D47A1" > {{ this.$store.state.enrolment_year }}</span>
</strong>
...
<button v-if="$store.state.loading_status"
class="btn btn-light "
 style="white-space: nowrap;" >
<b-spinner small style="height: 16px;width:16px;"></b-spinner>
<span style="font-weight: 600;padding-left:6px;">Loading...</span></button>
...
<PrimaryEnrolByRegion/>
</div>
<div class="change_content" v-else-if="$store.state.reportMenu==='table2'">
<PrimaryEnrolByClass/>
</div>

<div class="change_content" v-else-if="$store.state.reportMenu==='table4'">
<PrimaryEnrolByNationalityClass/>
</div>
<div class="change_content" v-else-if="$store.state.reportMenu==='table5'">
<PrimaryEnrolByAge/>
</div>

<div class="change_content" v-else-if="$store.state.reportMenu==='table6'">
<PrimaryEnrolByOwnership/>
</div>
<div class="change_content" v-else-if="$store.state.reportMenu==='table7'">
<PrimaryEnrolByClassAndYear/>
</div>
...
import PrimaryEnrolByAge from '../TableEnrolment/PrimaryEnrolByAge';
import PrimaryEnrolByNationalityClass from '../TableEnrolment/PrimaryEnrolByNationalityClass';
import PrimaryEnrolByClass from '../TableEnrolment/PrimaryEnrolByClass';
import PrimaryEnrolByRegion from '../TableEnrolment/PrimaryEnrolByRegion';
import PrimaryEnrolByOwnership from  '../TableEnrolment/PrimaryEnrolByOwnership';
import PrimaryEnrolByClassAndYear from  '../TableEnrolment/PrimaryEnrolByClassAndYear';
export default {
components:{
ActiveTab,
PrimaryEnrolByAge,
...
//custom data
menu:this.$store.state.reportMenu,
