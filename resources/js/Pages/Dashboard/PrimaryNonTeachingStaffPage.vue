...
<script>
import PrimaryWaterSourceTable from '../TablePrimaryWaterSource/PrimaryWaterSourceTable'
export default {
components:{
PrimaryWaterSourceTable,
},
...
this.$store.state.reportTitle='Type';
