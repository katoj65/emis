...
<thead>
<tr>
<th scope="col" style="vertical-align: top;width:100px;text-transform:capitalize;background:rgb(232, 232, 235);border-bottom:solid  2px #87CEFA;" v-for="head in headers">{{ head}} </th>
</tr>
</thead>
...
<tr :class="css_class+item1.id" style="border-top:solid thin #e5e9f2;display:none;background:rgb(232, 232, 235);">
...
<tbody style="background:rgb(232, 232, 235);border-top:solid  1px #87CEFA;">
<tr>
